...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IsAuth = field.NewInt32(tableName, "is_auth")
...
type user struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // 用户ID
	UID       field.String // 全局唯一ID(账户ID)
	Nickname  field.String // 昵称
	Sex       field.Int32  // 性别0未知1男2女
	Phone     field.String // 手机号
	Avatar    field.String // 用户头像
	Profile   field.String // 简介
	Level     field.Int32  // 会员级别
	Vip       field.Int32  // 会员等级
	IsAuth    field.Int32  // 是否认证 0:否 1:是
	Other     field.Field  // 其他数据
	Status    field.Int32  // 状态 1 正常 2锁定 3注销
...
func (u *user) updateTableName(table string) *user {
	...
	u.IsAuth = field.NewInt32(table, "is_auth")
