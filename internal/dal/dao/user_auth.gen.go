...
func newUserAuth(db *gorm.DB, opts ...gen.DOOption) userAuth {
	...
	_userAuth.UID = field.NewString(tableName, "uid")
	_userAuth.IdentityType = field.NewInt32(tableName, "identity_type")
	_userAuth.IdentityKey = field.NewString(tableName, "identity_key")
	_userAuth.IdentifierCode = field.NewString(tableName, "identifier_code")
	_userAuth.IdentityName = field.NewString(tableName, "identity_name")
	_userAuth.Other = field.NewField(tableName, "other")
	_userAuth.Status = field.NewInt32(tableName, "status")
	_userAuth.CreatedAt = field.NewTime(tableName, "created_at")
	_userAuth.UpdatedAt = field.NewTime(tableName, "updated_at")
	_userAuth.DeletedAt = field.NewField(tableName, "deleted_at")
...
type userAuth struct {
	...
	IdentityType   field.Int32  // 1 微信 2 苹果
	IdentityKey    field.String // 业务登录key
	IdentifierCode field.String // 标识码
	IdentityName   field.String // 昵称
	Other          field.Field  // 其他数据
	Status         field.Int32  // 状态 1绑定 0解绑
...
func (u *userAuth) updateTableName(table string) *userAuth {
	...
	u.IdentityType = field.NewInt32(table, "identity_type")
	u.IdentityKey = field.NewString(table, "identity_key")
	u.IdentifierCode = field.NewString(table, "identifier_code")
	u.IdentityName = field.NewString(table, "identity_name")
...
func (u *userAuth) WithContext(ctx context.Context) *userAuthDo { return u.userAuthDo.WithContext(ctx) }

func (u userAuth) TableName() string { return u.userAuthDo.TableName() }

func (u userAuth) Alias() string { return u.userAuthDo.Alias() }
...
func (u *userAuth) fillFieldMap() {
	...
	u.fieldMap["identity_type"] = u.IdentityType
	u.fieldMap["identity_key"] = u.IdentityKey
	u.fieldMap["identifier_code"] = u.IdentifierCode
	u.fieldMap["identity_name"] = u.IdentityName
