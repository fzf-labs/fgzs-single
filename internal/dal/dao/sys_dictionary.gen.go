...
func newSysDictionary(db *gorm.DB, opts ...gen.DOOption) sysDictionary {
	...
	_sysDictionary.Pid = field.NewInt64(tableName, "pid")
	_sysDictionary.Name = field.NewString(tableName, "name")
	_sysDictionary.Type = field.NewInt32(tableName, "type")
	_sysDictionary.UniqueKey = field.NewString(tableName, "unique_key")
	_sysDictionary.Value = field.NewString(tableName, "value")
	_sysDictionary.Status = field.NewInt32(tableName, "status")
	_sysDictionary.Sort = field.NewInt64(tableName, "sort")
...
type sysDictionary struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // 编号
	Pid       field.Int64  // 0=配置集 !0=父级id
	Name      field.String // 名称
	Type      field.Int32  // 1文本 2数字 3数组 4单选 5多选 6下拉 7日期 8时间 9单图 10多图 11单文件 12多文件
...
func (s sysDictionaryDo) Delete(models ...*model.SysDictionary) (result gen.ResultInfo, err error) {
