...
func newSensitiveCategory(db *gorm.DB, opts ...gen.DOOption) sensitiveCategory {
	...
	_sensitiveCategory.sensitiveCategoryDo.UseModel(&model.SensitiveCategory{})

	tableName := _sensitiveCategory.sensitiveCategoryDo.TableName()
	_sensitiveCategory.ALL = field.NewAsterisk(tableName)
	_sensitiveCategory.ID = field.NewInt64(tableName, "id")
...
func (s sensitiveCategoryDo) Create(values ...*model.SensitiveCategory) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sensitiveCategoryDo) CreateInBatches(values []*model.SensitiveCategory, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sensitiveCategoryDo) Save(values ...*model.SensitiveCategory) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sensitiveCategoryDo) First() (*model.SensitiveCategory, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.SensitiveCategory), nil
	}
}

func (s sensitiveCategoryDo) Take() (*model.SensitiveCategory, error) {
...
func (s sensitiveCategoryDo) Last() (*model.SensitiveCategory, error) {
...
func (s sensitiveCategoryDo) Find() ([]*model.SensitiveCategory, error) {
	result, err := s.DO.Find()
	return result.([]*model.SensitiveCategory), err
}

func (s sensitiveCategoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SensitiveCategory, err error) {
	buf := make([]*model.SensitiveCategory, 0, batchSize)
...
func (s sensitiveCategoryDo) FindInBatches(result *[]*model.SensitiveCategory, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sensitiveCategoryDo) FirstOrInit() (*model.SensitiveCategory, error) {
...
func (s sensitiveCategoryDo) FirstOrCreate() (*model.SensitiveCategory, error) {
...
func (s sensitiveCategoryDo) FindByPage(offset int, limit int) (result []*model.SensitiveCategory, count int64, err error) {
...
func (s sensitiveCategoryDo) Delete(models ...*model.SensitiveCategory) (result gen.ResultInfo, err error) {
