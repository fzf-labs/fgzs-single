...
func SysAdminInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysAdminInfoReq
		...
		l := admin.NewSysAdminInfoLogic(r.Context(), svcCtx)
		resp, err := l.SysAdminInfo(&req)
