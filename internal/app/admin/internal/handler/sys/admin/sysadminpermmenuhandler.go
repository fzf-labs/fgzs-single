...
func SysAdminPermMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysAdminPermMenuReq
		...
		l := admin.NewSysAdminPermMenuLogic(r.Context(), svcCtx)
		resp, err := l.SysAdminPermMenu(&req)
