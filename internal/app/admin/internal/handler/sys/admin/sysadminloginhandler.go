...
func SysAdminLoginHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysAdminLoginReq
		...
		l := admin.NewSysAdminLoginLogic(r.Context(), svcCtx)
		resp, err := l.SysAdminLogin(&req)
