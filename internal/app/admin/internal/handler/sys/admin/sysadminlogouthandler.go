...
func SysAdminLogoutHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysAdminLogoutReq
		...
		l := admin.NewSysAdminLogoutLogic(r.Context(), svcCtx)
		resp, err := l.SysAdminLogout(&req)
