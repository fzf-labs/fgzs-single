...
func SysAdminGenerateAvatarHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysAdminGenerateAvatarReq
		...
		l := admin.NewSysAdminGenerateAvatarLogic(r.Context(), svcCtx)
		resp, err := l.SysAdminGenerateAvatar(&req)
