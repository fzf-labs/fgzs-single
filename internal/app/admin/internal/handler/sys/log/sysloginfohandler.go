...
func SysLogInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysLogInfoReq
		...
		l := log.NewSysLogInfoLogic(r.Context(), svcCtx)
		resp, err := l.SysLogInfo(&req)
