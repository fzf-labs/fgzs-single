...
func SysPermMenuInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysPermMenuInfoReq
		...
		l := permmenu.NewSysPermMenuInfoLogic(r.Context(), svcCtx)
		resp, err := l.SysPermMenuInfo(&req)
