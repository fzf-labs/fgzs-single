...
func SysPermMenuListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysPermMenuListReq
		...
		l := permmenu.NewSysPermMenuListLogic(r.Context(), svcCtx)
		resp, err := l.SysPermMenuList(&req)
