...
func SysPermMenuStoreHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysPermMenuStoreReq
		...
		l := permmenu.NewSysPermMenuStoreLogic(r.Context(), svcCtx)
		resp, err := l.SysPermMenuStore(&req)
