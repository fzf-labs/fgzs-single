...
func SysJobDelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysJobDelReq
		...
		l := job.NewSysJobDelLogic(r.Context(), svcCtx)
		resp, err := l.SysJobDel(&req)
