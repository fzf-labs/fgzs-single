...
func SysJobStoreHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysJobStoreReq
		...
		l := job.NewSysJobStoreLogic(r.Context(), svcCtx)
		resp, err := l.SysJobStore(&req)
