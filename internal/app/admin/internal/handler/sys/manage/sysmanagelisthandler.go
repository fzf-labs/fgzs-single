...
func SysManageListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysManageListReq
		...
		l := manage.NewSysManageListLogic(r.Context(), svcCtx)
		resp, err := l.SysManageList(&req)
