...
func SysManageInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysManageInfoReq
		...
		l := manage.NewSysManageInfoLogic(r.Context(), svcCtx)
		resp, err := l.SysManageInfo(&req)
