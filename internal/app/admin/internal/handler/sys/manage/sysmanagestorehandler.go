...
import (
	"fgzs-single/internal/app/admin/internal/logic/sys/manage"
...
func SysManageStoreHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysManageStoreReq
		...
		l := manage.NewSysManageStoreLogic(r.Context(), svcCtx)
		resp, err := l.SysManageStore(&req)
