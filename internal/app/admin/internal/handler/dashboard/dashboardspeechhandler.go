...
import (
	"fgzs-single/internal/app/admin/internal/logic/dashboard"
...
func DashboardSpeechHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DashboardSpeechReq
		...
		l := dashboard.NewDashboardSpeechLogic(r.Context(), svcCtx)
		resp, err := l.DashboardSpeech(&req)
