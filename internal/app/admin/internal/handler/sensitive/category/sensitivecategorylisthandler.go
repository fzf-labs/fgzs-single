...
func SensitiveCategoryListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SensitiveCategoryListReq
		...
		l := category.NewSensitiveCategoryListLogic(r.Context(), svcCtx)
		resp, err := l.SensitiveCategoryList(&req)
